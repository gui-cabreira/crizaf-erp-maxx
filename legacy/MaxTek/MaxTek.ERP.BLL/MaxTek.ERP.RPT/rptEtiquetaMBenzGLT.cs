...
public class rptEtiquetaMBenzGLT : XtraReport
{
	...
	private void InitializeComponent()
	{
		...
		((XRControl)BottomMargin).HeightF = 80f;
		...
		((XRControl)Detail).HeightF = 1323.699f;
		...
		((XtraReport)this).Margins = new Margins(80, 80, 80, 80);
		((XtraReport)this).PageHeight = 1480;
		((XtraReport)this).PageWidth = 2100;
		((XtraReport)this).PaperKind = PaperKind.A5;
