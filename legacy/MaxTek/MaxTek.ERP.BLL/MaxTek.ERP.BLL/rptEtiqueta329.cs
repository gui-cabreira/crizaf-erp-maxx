...
public class rptEtiqueta329 : XtraReport
{
	...
	private void PageHeader_BeforePrint(object sender, PrintEventArgs e)
	{
		...
		((XRControl)txCodigoBarras).Text = ((XRControl)txCodigoCliente).Text;
	}
	...
	private void InitializeComponent()
	{
		...
		((XRControl)PageHeader).HeightF = 942.85f;
		...
		((XRControl)imLogoCliente).LocationFloat = new PointFloat(457.925f, 36.99997f);
		...
		((XRControl)xrLabel9).LocationFloat = new PointFloat(246.925f, 855.5501f);
		...
		((XRControl)txCodigoBarras).LocationFloat = new PointFloat(542.925f, 200.9999f);
		...
		((XRControl)xrLabel1).LocationFloat = new PointFloat(66.92499f, 109f);
		...
		((XRControl)xrLabel2).LocationFloat = new PointFloat(66.92499f, 209f);
		...
		((XRControl)xrLabel3).LocationFloat = new PointFloat(66.92499f, 318f);
		...
		((XRControl)xrLabel4).LocationFloat = new PointFloat(66.92499f, 423f);
		...
		((XRControl)xrLabel5).LocationFloat = new PointFloat(66.92499f, 601.55f);
		...
		((XRControl)xrLabel6).LocationFloat = new PointFloat(66.92499f, 706.55f);
		...
		((XRControl)xrLabel7).LocationFloat = new PointFloat(66.92499f, 812.55f);
		...
		((XRControl)txCliente).LocationFloat = new PointFloat(66.92499f, 152f);
		...
		((XRControl)txEmpresa).LocationFloat = new PointFloat(66.92499f, 251f);
		...
		((XRControl)txData).LocationFloat = new PointFloat(66.92499f, 360f);
		...
		((XRControl)txDescricao).LocationFloat = new PointFloat(66.92499f, 466f);
		...
		((XRControl)txDescricao).SizeF = new SizeF(466f, 127.25f);
		...
		((XRControl)txCodigoCliente).LocationFloat = new PointFloat(66.92499f, 643.55f);
		...
		((XRControl)txQuantidade).LocationFloat = new PointFloat(66.92499f, 749.55f);
		...
		((XRControl)txNotaFiscal).LocationFloat = new PointFloat(66.92499f, 855.5501f);
		...
		((XRControl)xrLine1).LocationFloat = new PointFloat(39.92498f, 11.00001f);
		...
		((XRControl)xrLine2).LocationFloat = new PointFloat(34.925f, 924.5501f);
		...
		((XRControl)xrLine3).LocationFloat = new PointFloat(34.925f, 11.00001f);
		((XRControl)xrLine3).Name = "xrLine3";
		((XRControl)xrLine3).SizeF = new SizeF(11f, 913.5502f);
		...
		((XRControl)xrLine4).LocationFloat = new PointFloat(725.925f, 11.00001f);
		((XRControl)xrLine4).Name = "xrLine4";
		((XRControl)xrLine4).SizeF = new SizeF(11f, 924.5502f);
		...
		((XRControl)imLogoEmpresa).LocationFloat = new PointFloat(66.92499f, 36.99997f);
		...
		((XRControl)txItemNota).LocationFloat = new PointFloat(275.925f, 855.5501f);
