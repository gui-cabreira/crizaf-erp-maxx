...
[Serializable]
public class NotaFiscalModalidadeBaseCalculoICMSST : BusinessObjectBase
{
	...
	public NotaFiscalModalidadeBaseCalculoICMSST()
	{
		IniciarVariaveis(isNovo: true);
	}

	public NotaFiscalModalidadeBaseCalculoICMSST(bool isNovo)
	{
