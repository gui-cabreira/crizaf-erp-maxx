...
public class rptEtiquetaIsringhausen : XtraReport
{
	...
	public rptEtiquetaIsringhausen()
	{
		InitializeComponent();
	}
	...
	private void PageHeader_BeforePrint(object sender, PrintEventArgs e)
	{
		...
		((XRControl)txEndereco).Text = $"{emitente.Endereco} - {emitente.Bairro} - {emitente.Cidade} -{emitente.Estado} - CEP: {emitente.CodigoPostal}";
	...
	private void InitializeComponent()
	{
		...
		((XRControl)PageHeader).Controls.AddRange((XRControl[])(object)new XRControl[37]
		{
			(XRControl)xrCarga,
			(XRControl)xrLabel29,
			(XRControl)txVersao,
		...
		((XRControl)xrCarga).Borders = (BorderSide)0;
		...
		((XRControl)xrCarga).LocationFloat = new PointFloat(756.9066f, 742.6458f);
		((XRControl)xrCarga).Name = "xrCarga";
		((XRControl)xrCarga).Padding = new PaddingInfo(5, 5, 0, 0, 254f);
		((XRControl)xrCarga).SizeF = new SizeF(711.0767f, 80.9375f);
		...
		((XRControl)xrLabel29).LocationFloat = new PointFloat(749.3228f, 708.2485f);
		xrLabel29.Multiline = true;
		((XRControl)xrLabel29).Name = "xrLabel29";
		((XRControl)xrLabel29).Padding = new PaddingInfo(5, 5, 0, 0, 254f);
		((XRControl)xrLabel29).SizeF = new SizeF(714.5103f, 33.37146f);
		...
		((XRControl)xrLabel29).Text = "(16) Charge No. / Carga nº";
		...
		((XRControl)txVersao).SizeF = new SizeF(408.0701f, 62f);
		...
		((XRControl)xrLabel26).SizeF = new SizeF(401.3469f, 30.43152f);
		...
		((XRControl)xrLabel26).Text = "(14) eng. Change / Alteração Engenharia";
		...
		((XRControl)xrLabel25).Text = "(13) Date / Data";
		...
		((XRControl)txCodigoPeca2).SizeF = new SizeF(716.3447f, 62f);
		...
		((XRControl)xrLabel23).LocationFloat = new PointFloat(743.8954f, 523.3854f);
		((XRControl)xrLabel23).Name = "xrLabel23";
		((XRControl)xrLabel23).Padding = new PaddingInfo(5, 5, 0, 0, 254f);
		((XRControl)xrLabel23).SizeF = new SizeF(721.0878f, 30.43155f);
		...
		((XRControl)xrLabel23).Text = "(11) Supplier Part No. / Nº da Peça no Fornecedor";
		...
		((XRControl)txLote).LocationFloat = new PointFloat(30.00006f, 742.6458f);
		((XRControl)txLote).Name = "txLote";
		((XRControl)txLote).Padding = new PaddingInfo(5, 5, 0, 0, 254f);
		((XRControl)txLote).SizeF = new SizeF(719.3228f, 63f);
		...
		((XRControl)xrLabel21).LocationFloat = new PointFloat(25f, 708.2484f);
		xrLabel21.Multiline = true;
		((XRControl)xrLabel21).Name = "xrLabel21";
		((XRControl)xrLabel21).Padding = new PaddingInfo(5, 5, 0, 0, 254f);
		((XRControl)xrLabel21).SizeF = new SizeF(723.7391f, 33.37146f);
		...
		((XRControl)xrLabel21).Text = "(15) Serial No./ Número de Série / Nº Rolo / Ordem de Serviço";
		...
		((XRControl)xrLabel19).LocationFloat = new PointFloat(29.41649f, 554.1113f);
		...
		((XRControl)xrLabel19).Text = "(12) Supplier No. / Fornecedor Nº";
		...
		((XRControl)txDescricaoProduto).SizeF = new SizeF(715.6605f, 61.99997f);
		...
		((XRControl)xrLabel17).LocationFloat = new PointFloat(748.4883f, 429.4117f);
		((XRControl)xrLabel17).Name = "xrLabel17";
		((XRControl)xrLabel17).Padding = new PaddingInfo(5, 5, 0, 0, 254f);
		((XRControl)xrLabel17).SizeF = new SizeF(716.495f, 30.43155f);
		...
		((XRControl)xrLabel17).Text = "(10) Description / Descrição";
		...
		((XRControl)xrLabel15).LocationFloat = new PointFloat(30.00006f, 429.4116f);
		((XRControl)xrLabel15).Name = "xrLabel15";
		((XRControl)xrLabel15).Padding = new PaddingInfo(5, 5, 0, 0, 254f);
		((XRControl)xrLabel15).SizeF = new SizeF(719.3226f, 30.43158f);
		...
		((XRControl)xrLabel15).Text = "(9) Quantity / Quantidade";
		...
		((XRControl)xrLabel9).Text = "(8) Part No. / Peça Nº / Código Matéria Prima";
		...
		((XRControl)txQtdCaixas).SizeF = new SizeF(242.6602f, 69.00003f);
		...
		((XRControl)xrLabel12).SizeF = new SizeF(247.5061f, 30.35045f);
		...
		((XRControl)xrLabel12).Text = "(7) nº Boxes/nº Emb.";
		...
		((XRControl)xrLabel11).Text = "(6) Gross Wt/PesoBruto";
		...
		((XRControl)xrLabel3).LocationFloat = new PointFloat(749.3228f, 218.6296f);
		((XRControl)xrLabel3).Name = "xrLabel3";
		((XRControl)xrLabel3).Padding = new PaddingInfo(5, 5, 0, 0, 254f);
		((XRControl)xrLabel3).SizeF = new SizeF(234.9999f, 30.35045f);
		...
		((XRControl)xrLabel3).Text = "(5) Net Wt/PesoLíquido";
		...
		((XRControl)txPesoLiq).LocationFloat = new PointFloat(749.3228f, 248.9801f);
		...
		((XRControl)txCodigoPeca).LocationFloat = new PointFloat(29.41648f, 349.4117f);
		((XRControl)txCodigoPeca).Name = "txCodigoPeca";
		((XRControl)txCodigoPeca).Padding = new PaddingInfo(5, 5, 0, 0, 254f);
		((XRControl)txCodigoPeca).SizeF = new SizeF(1435.567f, 80f);
		...
		((XRControl)txEndereco).SizeF = new SizeF(714.5103f, 70f);
		...
		((XRControl)xrLabel2).LocationFloat = new PointFloat(749.3228f, 119.5948f);
		((XRControl)xrLabel2).Name = "xrLabel2";
		((XRControl)xrLabel2).Padding = new PaddingInfo(5, 5, 0, 0, 254f);
		((XRControl)xrLabel2).SizeF = new SizeF(716.5103f, 29.03483f);
		...
		((XRControl)xrLabel2).Text = "(4) Supplier Adress / Endereço Forncedor";
		...
		((XRControl)xrLabel7).LocationFloat = new PointFloat(25f, 119.5948f);
		((XRControl)xrLabel7).Name = "xrLabel7";
		((XRControl)xrLabel7).Padding = new PaddingInfo(5, 5, 0, 0, 254f);
		((XRControl)xrLabel7).SizeF = new SizeF(719.3121f, 29.03483f);
		...
		((XRControl)xrLabel7).Text = "3) Advise Note No. / Nota Entrega nº (NF)";
		...
		((XRControl)txDoca).LocationFloat = new PointFloat(748.2296f, 49.59484f);
		((XRControl)txDoca).Name = "txDoca";
		((XRControl)txDoca).Padding = new PaddingInfo(5, 5, 0, 0, 254f);
		((XRControl)txDoca).SizeF = new SizeF(715.6035f, 70.00001f);
		...
		((XRControl)xrLabel5).LocationFloat = new PointFloat(760.4789f, 17.64584f);
		((XRControl)xrLabel5).Name = "xrLabel5";
		((XRControl)xrLabel5).Padding = new PaddingInfo(5, 5, 0, 0, 254f);
		((XRControl)xrLabel5).SizeF = new SizeF(697.631f, 31.94896f);
		...
		((XRControl)xrLabel5).Text = "(2) Dock - Gate / Portão";
		...
		((XRControl)txNomeFantasia).LocationFloat = new PointFloat(29.00004f, 49.59479f);
		...
		((XRControl)xrLabel1).LocationFloat = new PointFloat(29.00004f, 17.64584f);
		...
		((XRControl)xrLabel1).Text = "(1) Receiver/Local de Entrega /Cliente ";
		...
		((XRControl)xrLine2).LocationFloat = new PointFloat(22.84985f, 805.6458f);
		((XRControl)xrLine2).Name = "xrLine2";
		((XRControl)xrLine2).SizeF = new SizeF(1442.983f, 18.9375f);
		...
		((XRControl)xrLine1).LocationFloat = new PointFloat(20.00002f, 0f);
		((XRControl)xrLine1).Name = "xrLine1";
		((XRControl)xrLine1).SizeF = new SizeF(1444.833f, 17.64583f);
		...
		((XRControl)xrLine4).LocationFloat = new PointFloat(1458.833f, 0.999939f);
		((XRControl)xrLine4).Name = "xrLine4";
		((XRControl)xrLine4).SizeF = new SizeF(17.15002f, 821.5834f);
		...
		((XRControl)topMarginBand1).HeightF = 100.4527f;
		...
		((XtraReport)this).Margins = new Margins(0, 0, 100, 0);
