...
public class rptEtiquetaAllevardDatamatrix : XtraReport
{
	...
	public rptEtiquetaAllevardDatamatrix()
	{
		InitializeComponent();
	}
	...
	private void InitializeComponent()
	{
		...
		DataMatrixGenerator symbology = new DataMatrixGenerator();
		...
		((XRControl)imLogoCliente).LocationFloat = new PointFloat(386.6042f, 49f);
		...
		((XRControl)txCodigoBarras).LocationFloat = new PointFloat(508f, 150.0417f);
		...
		((XRControl)txCodigoBarras).SizeF = new SizeF(169f, 724.6483f);
