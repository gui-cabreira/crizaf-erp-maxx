...
internal class PervasiveNotaFiscalTipoIncidenciaIPI : INotaFiscalTipoIncidenciaIPI
{
	...
	private string ObterSql()
	{
		...
		stringBuilder.Append(" from " + BaseDadosERP.NomeBaseDados + "Erp.NFTipoIncidenciaIPI ");
	...
	public int InserirNotaFiscalTipoIncidenciaIPI(MapTableNotaFiscalTipoIncidenciaIPI NotaFiscalTipoIncidenciaIPI)
	{
		IList<DbParameter> list = new List<DbParameter>();
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append("Insert into " + BaseDadosERP.NomeBaseDados + "Erp.NFTipoIncidenciaIPI (");
	...
	public int AlterarNotaFiscalTipoIncidenciaIPI(MapTableNotaFiscalTipoIncidenciaIPI NotaFiscalTipoIncidenciaIPI, Hashtable camposAlterados)
	{
		...
		if (camposAlterados.Count > 0)
		{
			IList<DbParameter> list = new List<DbParameter>();
			StringBuilder stringBuilder = new StringBuilder();
			stringBuilder.Append("Update " + BaseDadosERP.NomeBaseDados + "Erp.NFTipoIncidenciaIPI Set ");
	...
	public int ExcluirNotaFiscalTipoIncidenciaIPI(int id)
	{
		IList<DbParameter> list = new List<DbParameter>();
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append("Delete from " + BaseDadosERP.NomeBaseDados + "Erp.NFTipoIncidenciaIPI ");
		stringBuilder.Append("Where ");
		stringBuilder.Append(" id = ?");
		list.Add(BaseDadosERP.ObterNovoParametro("id", id));
