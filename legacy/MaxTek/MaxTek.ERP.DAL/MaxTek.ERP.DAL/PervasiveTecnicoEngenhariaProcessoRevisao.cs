...
internal class PervasiveTecnicoEngenhariaProcessoRevisao : ITecnicoEngenhariaProcessoRevisao
{
	...
	private string ObterSql()
	{
		...
		stringBuilder.Append(" from " + BaseDadosERP.NomeBaseDados + "ERP.ProcessoRevisao ");
	...
	public int InserirTecnicoEngenhariaProcessoRevisao(MapTableTecnicoEngenhariaProcessoRevisao TecnicoEngenhariaProcessoRevisao)
	{
		IList<DbParameter> list = new List<DbParameter>();
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append("Insert into " + BaseDadosERP.NomeBaseDados + "ERP.ProcessoRevisao (");
		stringBuilder.Append("id_processo, ");
		...
		list.Add(BaseDadosERP.ObterNovoParametro("cd_funcionario_revis", TecnicoEngenhariaProcessoRevisao.codigoFuncionarioRevisor));
	...
	public int AlterarTecnicoEngenhariaProcessoRevisao(MapTableTecnicoEngenhariaProcessoRevisao TecnicoEngenhariaProcessoRevisao, Hashtable camposAlterados)
	{
		...
		if (camposAlterados.Count > 0)
		{
			IList<DbParameter> list = new List<DbParameter>();
			StringBuilder stringBuilder = new StringBuilder();
			stringBuilder.Append("Update " + BaseDadosERP.NomeBaseDados + "ERP.ProcessoRevisao Set ");
			...
			list.Add(BaseDadosERP.AddSQLSmartUpdate(stringBuilder, "CodigoFuncionarioRevisor", "cd_funcionario_revis", TecnicoEngenhariaProcessoRevisao.codigoFuncionarioRevisor, camposAlterados));
	...
	public int ExcluirTecnicoEngenhariaProcessoRevisao(int id)
	{
		IList<DbParameter> list = new List<DbParameter>();
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append("Delete from " + BaseDadosERP.NomeBaseDados + "ERP.ProcessoRevisao ");
		stringBuilder.Append("Where ");
		stringBuilder.Append(" id = ?");
		list.Add(BaseDadosERP.ObterNovoParametro("id", id));
