...
internal class SQLServerTecnicoEngenhariaProcessoOperacaoRevisao : ITecnicoEngenhariaProcessoOperacaoRevisao
{
	...
	private string ObterSql()
	{
		...
		stringBuilder.Append(" from [" + BaseDadosERP.NomeServidor + "].[" + BaseDadosERP.NomeBaseDados + "].[TecnicoEngenharia].[ProcessoOperacaoRevisao] ");
	...
	public int InserirTecnicoEngenhariaProcessoOperacaoRevisao(MapTableTecnicoEngenhariaProcessoOperacaoRevisao TecnicoEngenhariaProcessoOperacaoRevisao)
	{
		IList<DbParameter> list = new List<DbParameter>();
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append("Insert into [" + BaseDadosERP.NomeServidor + "].[" + BaseDadosERP.NomeBaseDados + "].[TecnicoEngenharia].[ProcessoOperacaoRevisao] (");
		...
		stringBuilder.Append("[ds_sql_utilizado]) Values (@id_processo_operacao,@cd_revisao,@ds_modificacao,@dt_revisao,@cd_funcionario_revisor,@nm_conectado,@ds_sql_utilizado) ");
		...
		list.Add(BaseDadosERP.ObterNovoParametro("@cd_funcionario_revisor", TecnicoEngenhariaProcessoOperacaoRevisao.codigoFuncionarioRevisor));
	...
	public int AlterarTecnicoEngenhariaProcessoOperacaoRevisao(MapTableTecnicoEngenhariaProcessoOperacaoRevisao TecnicoEngenhariaProcessoOperacaoRevisao, Hashtable camposAlterados)
	{
		...
		if (camposAlterados.Count > 0)
		{
			IList<DbParameter> list = new List<DbParameter>();
			StringBuilder stringBuilder = new StringBuilder();
			stringBuilder.Append("Update [" + BaseDadosERP.NomeServidor + "].[" + BaseDadosERP.NomeBaseDados + "].[TecnicoEngenharia].[ProcessoOperacaoRevisao] Set ");
			...
			list.Add(BaseDadosERP.AddSQLSmartUpdate(stringBuilder, "CodigoFuncionarioRevisor", "cd_funcionario_revisor", TecnicoEngenhariaProcessoOperacaoRevisao.codigoFuncionarioRevisor, camposAlterados));
	...
	public int ExcluirTecnicoEngenhariaProcessoOperacaoRevisao(int id)
	{
		IList<DbParameter> list = new List<DbParameter>();
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append("Delete from [" + BaseDadosERP.NomeServidor + "].[" + BaseDadosERP.NomeBaseDados + "].[TecnicoEngenharia].[ProcessoOperacaoRevisao] ");
		stringBuilder.Append("Where ");
		stringBuilder.Append(" [id] = @id");
		list.Add(BaseDadosERP.ObterNovoParametro("@id", id));
