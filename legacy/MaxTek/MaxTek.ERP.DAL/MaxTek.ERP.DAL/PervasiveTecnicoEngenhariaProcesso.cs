...
internal class PervasiveTecnicoEngenhariaProcesso : ITecnicoEngenhariaProcesso
{
	...
	private string ObterSql()
	{
		...
		stringBuilder.Append("cd_funcionario_criac as codigoFuncionarioCriacao, ");
		stringBuilder.Append("cd_funcionario_modif as codigoFuncionarioModificacao, ");
		...
		stringBuilder.Append(" from " + BaseDadosERP.NomeBaseDados + "ERP.EngenhariaProcesso ");
	...
	public int InserirTecnicoEngenhariaProcesso(MapTableTecnicoEngenhariaProcesso TecnicoEngenhariaProcesso)
	{
		IList<DbParameter> list = new List<DbParameter>();
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append("Insert into " + BaseDadosERP.NomeBaseDados + "ERP.EngenhariaProcesso (");
		...
		stringBuilder.Append("cd_funcionario_criac, ");
		stringBuilder.Append("cd_funcionario_modif, ");
		...
		list.Add(BaseDadosERP.ObterNovoParametro("cd_funcionario_criac", TecnicoEngenhariaProcesso.codigoFuncionarioCriacao));
		list.Add(BaseDadosERP.ObterNovoParametro("cd_funcionario_modif", TecnicoEngenhariaProcesso.codigoFuncionarioModificacao));
		list.Add(BaseDadosERP.ObterNovoParametro("cd_funcionario_aprov", TecnicoEngenhariaProcesso.codigoFuncionarioAprovacao));
	...
	public int AlterarTecnicoEngenhariaProcesso(MapTableTecnicoEngenhariaProcesso TecnicoEngenhariaProcesso, Hashtable camposAlterados)
	{
		...
		if (camposAlterados.Count > 0)
		{
			IList<DbParameter> list = new List<DbParameter>();
			StringBuilder stringBuilder = new StringBuilder();
			stringBuilder.Append("Update " + BaseDadosERP.NomeBaseDados + "ERP.EngenhariaProcesso Set ");
			...
			list.Add(BaseDadosERP.AddSQLSmartUpdate(stringBuilder, "CodigoFuncionarioCriacao", "cd_funcionario_criac", TecnicoEngenhariaProcesso.codigoFuncionarioCriacao, camposAlterados));
			list.Add(BaseDadosERP.AddSQLSmartUpdate(stringBuilder, "CodigoFuncionarioModificacao", "cd_funcionario_modif", TecnicoEngenhariaProcesso.codigoFuncionarioModificacao, camposAlterados));
			list.Add(BaseDadosERP.AddSQLSmartUpdate(stringBuilder, "CodigoFuncionarioAprovacao", "cd_funcionario_aprov", TecnicoEngenhariaProcesso.codigoFuncionarioAprovacao, camposAlterados));
	...
	public int ExcluirTecnicoEngenhariaProcesso(int id)
	{
		IList<DbParameter> list = new List<DbParameter>();
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append("Delete from " + BaseDadosERP.NomeBaseDados + "ERP.EngenhariaProcesso ");
		stringBuilder.Append("Where ");
		stringBuilder.Append(" id = ?");
		list.Add(BaseDadosERP.ObterNovoParametro("id", id));
