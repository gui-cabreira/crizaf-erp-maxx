...
internal class SQLServerTecnicoEngenhariaProcessoMateria : ITecnicoEngenhariaProcessoMateria
{
	...
	private string ObterSql()
	{
		...
		stringBuilder.Append("[cd_tipo_materia_prima] as [codigoTipoMateriaPrima], ");
		...
		stringBuilder.Append(" from [" + BaseDadosERP.NomeServidor + "].[" + BaseDadosERP.NomeBaseDados + "].[TecnicoEngenharia].[ProcessoMateria] ");
	...
	public int InserirTecnicoEngenhariaProcessoMateria(MapTableTecnicoEngenhariaProcessoMateria TecnicoEngenhariaProcessoMateria)
	{
		IList<DbParameter> list = new List<DbParameter>();
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append("Insert into [" + BaseDadosERP.NomeServidor + "].[" + BaseDadosERP.NomeBaseDados + "].[TecnicoEngenharia].[ProcessoMateria] (");
		...
		stringBuilder.Append("[cd_tipo_materia_prima], ");
		...
		stringBuilder.Append("[cd_posicao_desenho]) Values (@id_processo,@id_processo_operacao,@id_materia_prima,@nm_materia_prima,@cd_tipo_materia_prima,@vl_dim_01,@vl_dim_02,@vl_dim_03,@vl_necessidade,@vl_tamanho,@ic_loteada,@pc_perda,@cd_indice_materia,@cd_posicao_desenho) ");
		...
		list.Add(BaseDadosERP.ObterNovoParametro("@cd_tipo_materia_prima", TecnicoEngenhariaProcessoMateria.codigoTipoMateriaPrima));
	...
	public int AlterarTecnicoEngenhariaProcessoMateria(MapTableTecnicoEngenhariaProcessoMateria TecnicoEngenhariaProcessoMateria, Hashtable camposAlterados)
	{
		...
		if (camposAlterados.Count > 0)
		{
			IList<DbParameter> list = new List<DbParameter>();
			StringBuilder stringBuilder = new StringBuilder();
			stringBuilder.Append("Update [" + BaseDadosERP.NomeServidor + "].[" + BaseDadosERP.NomeBaseDados + "].[TecnicoEngenharia].[ProcessoMateria] Set ");
			...
			list.Add(BaseDadosERP.AddSQLSmartUpdate(stringBuilder, "CodigoTipoMateriaPrima", "cd_tipo_materia_prima", TecnicoEngenhariaProcessoMateria.codigoTipoMateriaPrima, camposAlterados));
	...
	public int ExcluirTecnicoEngenhariaProcessoMateria(int id)
	{
		IList<DbParameter> list = new List<DbParameter>();
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append("Delete from [" + BaseDadosERP.NomeServidor + "].[" + BaseDadosERP.NomeBaseDados + "].[TecnicoEngenharia].[ProcessoMateria] ");
		stringBuilder.Append("Where ");
		stringBuilder.Append(" [id] = @id");
		list.Add(BaseDadosERP.ObterNovoParametro("@id", id));
