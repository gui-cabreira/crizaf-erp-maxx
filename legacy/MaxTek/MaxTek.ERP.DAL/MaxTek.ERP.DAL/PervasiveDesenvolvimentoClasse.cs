...
internal class PervasiveDesenvolvimentoClasse : IDesenvolvimentoClasse
{
	...
	private string ObterSql()
	{
		...
		stringBuilder.Append(" from " + BaseDadosERP.NomeBaseDados + "Erp.DevClasse ");
	...
	public int InserirDesenvolvimentoClasse(MapTableDesenvolvimentoClasse DesenvolvimentoClasse)
	{
		IList<DbParameter> list = new List<DbParameter>();
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append("Insert into " + BaseDadosERP.NomeBaseDados + "Erp.DevClasse (");
		...
		stringBuilder.Append("nm_tabela_pervasive) Values (?,?,?,?,?,?,?) ");
	...
	public int AlterarDesenvolvimentoClasse(MapTableDesenvolvimentoClasse DesenvolvimentoClasse, Hashtable camposAlterados)
	{
		...
		if (camposAlterados.Count > 0)
		{
			IList<DbParameter> list = new List<DbParameter>();
			StringBuilder stringBuilder = new StringBuilder();
			stringBuilder.Append("Update " + BaseDadosERP.NomeBaseDados + "Erp.DevClasse Set ");
	...
	public int ExcluirDesenvolvimentoClasse(int id)
	{
		IList<DbParameter> list = new List<DbParameter>();
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.Append("Delete from " + BaseDadosERP.NomeBaseDados + "Erp.DevClasse ");
		stringBuilder.Append("Where ");
		stringBuilder.Append(" id = ?");
		list.Add(BaseDadosERP.ObterNovoParametro("id", id));
